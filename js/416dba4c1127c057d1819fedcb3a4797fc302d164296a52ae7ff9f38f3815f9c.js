!function(t) {
    ...
    class i {
        ...
        runOnResize(t, n) {
            ...
            n.runOnLoad && function(t, n=Number.MAX_VALUE) {
                var i;
    ...
    class a {
        ...
        static rotate(t) {
            let n = Math.cos(t)
              , e = Math.sin(t);
            return 1 === Math.abs(n) ? e = 0 : 1 === Math.abs(e) && (n = 0),
            new a(1,n,-e,0,e,n,0)
        }
    ...
    class h {
        ...
        static fromCenterBox({center: t, width: n, height: e, rotation: i}) {
        ...
        scaleAroundToContain(t, n, e) {
            ...
            let x = 0;
            return m < -e && (x = Math.max(x, m / u)),
            f < -e && (x = Math.max(x, f / l)),
            p > e && (x = Math.max(x, p / d)),
            g > e && (x = Math.max(x, g / w)),
            x
        }
        center() {
        ...
        corners() {
            ...
            if (0 === this.rotation)
                return [new r(t,n), new r(e,n), new r(t,i), new r(e,i)];
            {
    ...
    function c(t) {
        const {containerWidth: n, containerHeight: e} = t.dataset;
        if (!n || !e)
            return;
        const i = new h(0,0,parseFloat(e),parseFloat(n))
          , {imageboxWidth: s, imageboxHeight: o, imageboxTop: r, imageboxLeft: c, imageboxRotation: u} = t.dataset;
        if (!(s && o && r && c && u))
            return;
        const l = new h(parseFloat(r),parseFloat(c),parseFloat(o),parseFloat(s),parseFloat(u))
          , {width: d, height: w} = t.parentElement.getBoundingClientRect()
          , m = {
            x: d / 2,
            y: w / 2
        }
    ...
    t.radiansToDegrees = o,
    t.scaleRotatedFill = c,
